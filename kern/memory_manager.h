...
// Page tables entries
void pt_clear_page_table_entry(struct Env *e, uint32 virtual_address);
void pt_set_page_permissions(struct Env *e, uint32 virtual_address, uint32 permissions_to_set, uint32 permissions_to_clear);
uint32 pt_get_page_permissions(struct Env *e, uint32 virtual_address);
